...
class Plant_review extends StatefulWidget {
  const Plant_review({super.key});

  @override
  State<Plant_review> createState() => _Plant_reviewState();
}

class _Plant_reviewState extends State<Plant_review> {
  @override
              ...
              children: [
                ...
                "Air Purifier",
                  ...
                  style: TextStyle(
                    ...
                    Row(
                      children: [
                        PlantDetails(Icons.water_drop_outlined, "Every 1-2 Weeks","WATER"),
                       PlantDetails(Icons.wb_sunny_outlined, "Medium, Indirect","LIGHT"),
